...
Use this workflow to turn a structurally validated, classified canonical
provenance table into a concise, reader-facing Methods outline.
...
- [Inputs](#inputs)
- [Output and buckets](#output)
- [Roles and workflows](#roles)
- [Bucket definitions](#bucket-definitions)
- [Reconciliation report](#reconciliation-report-format)
- [Rules](#rules)
...
-   Keep excluded nodes out of the outline unless they provide necessary context.
