...
- For batches of model runs, prefer a checked-in or generated TSV spec file over long positional argument lists. The
  current `gpath` optimisation wrapper follows `bash slurm/submit_gpath_optim_pipeline.sh <spec.tsv>`.
